...
final class TypeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getIsCallsSubMethodsTestData(): array
    {
        ...
        return [
            ...
            'is() calls isOfTypeName(); isOfTypeName() returns true' => [
                $this->mockTypeIsOfTypeName($mockedTypeName, true),
                $mockedTypeName,
                true
            ],
            'is() calls isOfTypeName(); isOfTypeName() returns false' => [
                $this->mockTypeIsOfTypeName($mockedTypeName, false),
                $mockedTypeName,
                false
            ],
        ];
    ...
    /**
     * Mock Type->isOfTypeName()
     *
     * @param string $typeName The type name
     * @param bool $returnValue The return value
     */
    private function mockTypeIsOfTypeName(string $typeName, bool $returnValue): Type
    {
        return new class($typeName, $returnValue) extends Type
        {
            private $returnValue;
